 ...
 * @param props.disabled - Indicates if the button is displayed as disabled.
...
const Button = (props: IButtonProps) => {
  ...
  const btnClass = classNames({
    ...
    'text-white bg-primary-700 border-gray-100 hover:bg-primary-900 active:bg-primary-800':
      !props.secondary && !props.red && !props.green,
  ...
  return (
    ...
    <div className={`inline-flex items-center justify-center rounded-md border ${btnClass}`}>
      {props.loading && (
        <svg
